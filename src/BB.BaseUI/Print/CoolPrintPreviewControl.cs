...
public class CoolPrintPreviewControl : UserControl
{
    ...
    System.Drawing.Image GetImage(int page)
    {
        return page > -1 && page < PageCount ? _img[page] : null;
    }
    Rectangle GetImageRectangle(System.Drawing.Image img)
    {
    ...
    Size GetImageSizeInPixels(System.Drawing.Image img)
    {
        // get image size
    ...
    void RenderPage(Graphics g, System.Drawing.Image img, Rectangle rc)
    {
        // draw the page
        rc.Offset(1, 1);
