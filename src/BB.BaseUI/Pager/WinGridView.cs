...
/// 不带分页导航的列表展示控件
/// </summary>
public partial class WinGridView : XtraUserControl
{
    /// <summary>
    /// 是否显示CheckBox列
    /// </summary>
    ...
    {
        get => menu_Export.Enabled;
        set => menu_Export.Enabled = value;
    }
    /// <summary>
    /// 是否显示新建菜单
    /// </summary>
    ...
    private void bg_DoWork(object sender, DoWorkEventArgs e)
    {
        ...
        if (AllToExport != null && _isExportAllPage)
        {
            ...
            foreach (DataColumn column in table.Columns)
            {
                ...
                {
                    column.Caption = _columnNameAlias[originalName];
    ...
    private void gridView1_DataSourceChanged(object sender, EventArgs e)
    {
        ...
        foreach (GridColumn col in gridView1.Columns)
        {
            ...
            //col.VisibleIndex = GetDisplayColumnIndex(originalName);
